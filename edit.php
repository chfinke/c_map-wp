...
?>
    ...
    <form name="data" method="POST" onsubmit="return form_validation()" action="<?php echo get_bloginfo('wpurl'); ?>/crowdmap/edit">
...
<?php
            ...
            if ($cnt>0){
                ...
                foreach ( $posts as $post ) {
                    ...
                    $body .= "<li><a href=\"".get_bloginfo('wpurl')."/crowdmap/edit?id=".$post->ID."&token=".$token."\">".$post->post_title."</a></li>";
                }
                $body .= '</ul>';
...
?>
    <form name="data" method="POST" onsubmit="return form_validation()" action="<?php echo get_bloginfo('wpurl'); ?>/crowdmap/functions?action=save">
...
?>
        <input type="submit" value="Ändern"/>
        <input type="button" value="Löschen" onclick="window.location.href='<?php echo get_bloginfo('wpurl'); ?>/crowdmap/functions?action=delete&id=<?php echo $id; ?>&token=<?php echo $token; ?>'"/>
<?php
                } else {
?>
